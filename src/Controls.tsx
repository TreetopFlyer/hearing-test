    ...
    return <UI>
        ...
        <dl>
            ...
            <dl>
                ...
                <dd>
                    <Button onClick={()=>Dispatch(Store.Actions.Mark, 1)}>
                    ...
                    <Button onClick={()=>Dispatch(Store.Actions.Mark, 0)}>
                        <svg className="large" viewBox="0 0 80 80">
                    ...
                    <Button onClick={()=>{Dispatch(Store.Actions.Mark, -1)}} disabled={!currentChan.Sample}>
                        <svg className="large" viewBox="0 0 80 80">
